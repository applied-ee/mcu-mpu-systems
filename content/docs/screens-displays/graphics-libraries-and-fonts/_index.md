...
- **[Font Rendering on Embedded Displays]({{< relref "font-rendering" >}})** — Bitmap fonts vs anti-aliased, conversion tools, proportional vs monospace, and the memory budget that grows faster than expected.
