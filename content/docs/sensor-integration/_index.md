...
- **[Optical & Proximity Sensors]({{< relref "optical-and-proximity" >}})** — Photodiodes, phototransistors, ambient light and UV sensors, IR proximity and gesture detection, color/spectral measurement, and camera module integration for image capture.
