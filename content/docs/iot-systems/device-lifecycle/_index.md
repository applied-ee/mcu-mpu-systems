...
The tooling and infrastructure for each lifecycle stage depends on the [platform architecture]({{< relref "/docs/iot-systems/platform-architecture" >}}) — cloud platforms provide managed provisioning services and OTA delivery, while self-hosted deployments build these capabilities from individual components.
